...
export default class TimeTable extends React.Component {
  ...
  render() {
    ...
    return (
      <div ref="wrapper" style={{border: "1px solid gray", width: this.props.width, height: this.props.height, overflow: "auto", margin:0,padding:0}}>
          <div style={{width: timeWidth, height: 24, zIndex:4,left:0,top:0,position: 'absolute',display: 'block',backgroundColor: 'blue'}}>
            123
          </div>
